...
1. `/项目名/docs/PRD.md` — 产品需求，理解业务逻辑和数据格式
2. `/项目名/docs/TECH_SPEC.md` — 技术规范，遵循项目结构、API 端点、数据模型
3. `/项目名/docs/ARCHITECTURE.md` — 架构设计，遵循分层架构和组件职责
4. `/项目名/docs/CONVENTIONS.md` — 编码规范，遵循命名、错误处理、日志等约定

## 已有原型代码

`/项目名/P1/` 文件夹中包含已有的原型代码或部分实现。你需要：
